...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.button_profile = QPushButton("Создать")

        for btn in [self.button_main, self.button_profile]:
    ...
    def switch_page(self):
        ...
        self.stacked_widget.setCurrentIndex(list(self.pages.keys()).index(page_name))
